				...
				new BroadcastReceiver() {
					...
					public void onReceive(Context context, Intent intent) {
						...
						if (Activity.RESULT_OK != getResultCode() ) {
							...
							Intent restartMainActivityIntent = new Intent(mParentActivity.getApplicationContext(),mParentActivity.getClass());
							final PendingIntent pendingIntent = PendingIntent.getActivity(mParentActivity.getApplicationContext(), 0,
							...
							// successfully
							//mText = mApplicationContext.getV
