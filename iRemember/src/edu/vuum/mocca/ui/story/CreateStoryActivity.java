...
public class CreateStoryActivity extends StoryActivityBase {
	...
	private void launchSoundIntent() {
		...
		Intent intent = new Intent(getApplicationContext(), SoundRecordActivity.class);
		...
		intent.putExtra(SoundRecordActivity.EXTRA_OUTPUT, f.getAbsolutePath());
	...
	private void launchCameraIntent() {
		...
		fragment.imagePath = Uri.parse(f.getAbsolutePath());
